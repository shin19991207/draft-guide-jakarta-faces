...
Check out the web application at http://localhost:9080/index.xhtml. You can click on the refresh button image:refresh.png[refresh icon, 16, 16] to update and display the latest system load data in the table.
