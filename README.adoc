...
Check out the web application at http://localhost:9080/index.xhtml. Click the refresh button image:refresh.png[refresh icon, 20, 20], located next to the table title, to update and display the latest system load data in the table.
